...
<body>
    ...
    <div class="container-fluid">
        <h2 class="display-4 text-center">Modificacion de empleado</h2>
                ...
                <div class="card-body bg-light">
                    <form class="form-horizontal" role="form" id='formulario'>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input value="<?php echo $_POST['correo']; ?>" type="text" class="form-control" id="correo" placeholder="Email" readonly>
                        </div>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" class="form-control" id="legajo" placeholder="Legajo" readonly>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="clave" placeholder="Contraseña">
                        ...
                        <div class="form-group">
                            <div class="row d-flex justify-content-center">
                                <a style="width:90%;" class="btn btn-primary text-light mt-2" onclick="Test.Manejadora.ModificarEmpleado()">Modificar</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="./cargarModificar.js"></script>
</html>